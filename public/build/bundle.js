...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", div_id_value = /*pieceConfig*/ ctx[0].pieceId);
    			set_style(div, "width", "54px");
    			set_style(div, "height", "108px");
    			set_style(div, "background", /*pieceConfig*/ ctx[0].pieceColor);
    			set_style(div, "transform", "rotate(" + /*angle*/ ctx[1] + "deg)");
    			attr_dev(div, "class", "svelte-1fufun3");
    			add_location(div, file$1, 53, 0, 984);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*pieceConfig*/ 1 && div_id_value !== (div_id_value = /*pieceConfig*/ ctx[0].pieceId)) {
    				attr_dev(div, "id", div_id_value);
    			}

    			if (dirty & /*pieceConfig*/ 1) {
    				set_style(div, "background", /*pieceConfig*/ ctx[0].pieceColor);
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { pieceConfig = { pieceId, pieceColor } } = $$props;
    	let angle = 0;
    	let isDrag = false;
    	...
    	const writable_props = ["pieceConfig"];
    	...
    	return [pieceConfig, angle, click];
    }

    class PuzzlePiece extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { pieceConfig: 0 });
    ...
    function create_fragment(ctx) {
    	...
    	puzzlepiece0 = new PuzzlePiece({
    			props: { pieceConfig: /*pieceConfig*/ ctx[1] },
    			$$inline: true
    		});

    	puzzlepiece1 = new PuzzlePiece({
    			props: { pieceConfig: /*pieceConfig2*/ ctx[2] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 19, 1, 226);
    			attr_dev(td0, "class", "svelte-xzvql8");
    			add_location(td0, file, 26, 4, 355);
    			attr_dev(td1, "class", "svelte-xzvql8");
    			add_location(td1, file, 27, 4, 372);
    			attr_dev(td2, "class", "svelte-xzvql8");
    			add_location(td2, file, 28, 4, 389);
    			attr_dev(td3, "class", "svelte-xzvql8");
    			add_location(td3, file, 29, 4, 406);
    			attr_dev(td4, "class", "svelte-xzvql8");
    			add_location(td4, file, 30, 4, 423);
    			attr_dev(td5, "class", "svelte-xzvql8");
    			add_location(td5, file, 31, 4, 440);
    			add_location(tr0, file, 25, 3, 346);
    			attr_dev(td6, "class", "svelte-xzvql8");
    			add_location(td6, file, 35, 4, 497);
    			attr_dev(td7, "class", "svelte-xzvql8");
    			add_location(td7, file, 36, 4, 515);
    			attr_dev(td8, "class", "svelte-xzvql8");
    			add_location(td8, file, 37, 4, 532);
    			attr_dev(td9, "class", "svelte-xzvql8");
    			add_location(td9, file, 38, 4, 549);
    			attr_dev(td10, "class", "svelte-xzvql8");
    			add_location(td10, file, 39, 4, 566);
    			attr_dev(td11, "class", "svelte-xzvql8");
    			add_location(td11, file, 40, 4, 583);
    			add_location(tr1, file, 34, 3, 488);
    			attr_dev(td12, "class", "svelte-xzvql8");
    			add_location(td12, file, 44, 4, 640);
    			attr_dev(td13, "class", "svelte-xzvql8");
    			add_location(td13, file, 45, 4, 656);
    			attr_dev(td14, "class", "svelte-xzvql8");
    			add_location(td14, file, 46, 4, 671);
    			attr_dev(td15, "class", "svelte-xzvql8");
    			add_location(td15, file, 47, 4, 686);
    			attr_dev(td16, "class", "svelte-xzvql8");
    			add_location(td16, file, 48, 4, 701);
    			attr_dev(td17, "class", "svelte-xzvql8");
    			add_location(td17, file, 49, 4, 716);
    			attr_dev(td18, "class", "svelte-xzvql8");
    			add_location(td18, file, 50, 4, 731);
    			add_location(tr2, file, 43, 3, 631);
    			attr_dev(td19, "class", "svelte-xzvql8");
    			add_location(td19, file, 53, 4, 763);
    			attr_dev(td20, "class", "svelte-xzvql8");
    			add_location(td20, file, 54, 4, 779);
    			attr_dev(td21, "class", "svelte-xzvql8");
    			add_location(td21, file, 55, 4, 794);
    			attr_dev(td22, "class", "svelte-xzvql8");
    			add_location(td22, file, 56, 4, 810);
    			attr_dev(td23, "class", "svelte-xzvql8");
    			add_location(td23, file, 57, 4, 826);
    			attr_dev(td24, "class", "svelte-xzvql8");
    			add_location(td24, file, 58, 4, 842);
    			attr_dev(td25, "class", "svelte-xzvql8");
    			add_location(td25, file, 59, 4, 858);
    			add_location(tr3, file, 52, 3, 754);
    			attr_dev(td26, "class", "svelte-xzvql8");
    			add_location(td26, file, 62, 4, 891);
    			attr_dev(td27, "class", "svelte-xzvql8");
    			add_location(td27, file, 63, 4, 908);
    			attr_dev(td28, "class", "svelte-xzvql8");
    			add_location(td28, file, 64, 4, 924);
    			attr_dev(td29, "class", "svelte-xzvql8");
    			add_location(td29, file, 65, 4, 940);
    			attr_dev(td30, "class", "svelte-xzvql8");
    			add_location(td30, file, 66, 4, 956);
    			attr_dev(td31, "class", "svelte-xzvql8");
    			add_location(td31, file, 67, 4, 972);
    			attr_dev(td32, "class", "svelte-xzvql8");
    			add_location(td32, file, 68, 4, 988);
    			add_location(tr4, file, 61, 3, 882);
    			attr_dev(td33, "class", "svelte-xzvql8");
    			add_location(td33, file, 71, 4, 1021);
    			attr_dev(td34, "class", "svelte-xzvql8");
    			add_location(td34, file, 72, 4, 1038);
    			attr_dev(td35, "class", "svelte-xzvql8");
    			add_location(td35, file, 73, 4, 1054);
    			attr_dev(td36, "class", "svelte-xzvql8");
    			add_location(td36, file, 74, 4, 1070);
    			attr_dev(td37, "class", "svelte-xzvql8");
    			add_location(td37, file, 75, 4, 1086);
    			attr_dev(td38, "class", "svelte-xzvql8");
    			add_location(td38, file, 76, 4, 1102);
    			attr_dev(td39, "class", "svelte-xzvql8");
    			add_location(td39, file, 77, 4, 1118);
    			add_location(tr5, file, 70, 3, 1012);
    			attr_dev(td40, "class", "svelte-xzvql8");
    			add_location(td40, file, 80, 4, 1151);
    			attr_dev(td41, "class", "svelte-xzvql8");
    			add_location(td41, file, 81, 4, 1167);
    			attr_dev(td42, "class", "svelte-xzvql8");
    			add_location(td42, file, 82, 4, 1183);
    			add_location(tr6, file, 79, 3, 1142);
    			attr_dev(table, "border", "1");
    			set_style(table, "width", "396px");
    			set_style(table, "margin", "auto");
    			add_location(table, file, 23, 2, 288);
    			attr_dev(div, "class", "mainDiv");
    			set_style(div, "width", "100%");
    			add_location(div, file, 21, 1, 244);
    			attr_dev(main, "class", "svelte-xzvql8");
    			add_location(main, file, 18, 0, 218);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { name } = $$props;
    	let pieceConfig = { pieceId: "qqq", pieceColor: "red" };
    	let pieceConfig2 = { pieceId: "222", pieceColor: "green" };
